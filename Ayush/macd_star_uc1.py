...
class Trader:
    ...
    def compute_starfruit_macd(self, mid_price):
        ...
        ema_fast = (2/4) * ema_fast + (2/4) * mid_price
        # Calculate the long-term exponential moving average (EMA)
        ema_slow = ( 98/ 100) * ema_slow + (2/100) * mid_price
        # Calculate the MACD line
        macd_line = ema_fast - ema_slow
        # Calculate the signal line
        signal_line = (1/3) * signal_line + (2/3) * macd_line
    ...
    def compute_orders_sf(self, order_depth, macd_hist):
        ...
        undercut_buy = best_bid + 2
        undercut_sell = best_ask - 2
