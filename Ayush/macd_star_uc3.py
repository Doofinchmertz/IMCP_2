...
class Trader:
    ...
    def compute_starfruit_macd(self, mid_price, f_period=2, s_period=99, signal_period=6):
        # print("hi")
    ...
    def compute_orders_sf(self, order_depth, macd_hist):
        ...
        if macd_hist < -0.01:
            if curr_pos < STARFRUIT_POS_LIMIT:
                ...
                print(num, "num")
                orders.append(Order("STARFRUIT", best_bid, num))
                curr_pos += num
                print("lele_bhenchod")
        ...
        if macd_hist > 0.01:
            if curr_pos > -STARFRUIT_POS_LIMIT:
                ...
                orders.append(Order("STARFRUIT", best_ask, num))
                curr_pos += num
                print("bech bhenchod")
