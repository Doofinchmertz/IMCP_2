    ...
    def run(self, state: TradingState):
        ...
        for product in state.order_depths:
            ...
            if product == "AMETHYSTS":
                ...
                if (best_ask - best_bid > 5 and best_ask >= 10005):
                    orders.append(Order(product, best_ask-2, -5))
                    orders.append(Order(product, best_ask-1, 1))

                elif (best_ask - best_bid > 5 and best_bid <= 9995):
                    orders.append(Order(product, best_bid+2, 5))
